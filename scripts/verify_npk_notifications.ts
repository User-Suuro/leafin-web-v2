...
async function runTest() {
    ...
    console.log("--- Sending Low Nitrogen (10) ---");
    await fetch(`${baseUrl}/send-data`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ ...commonData, nitrogen: "10", phosphorus: "50", potassium: "50" }),
    });

    console.log("--- Sending High Phosphorus (150) ---");
    await fetch(`${baseUrl}/send-data`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ ...commonData, nitrogen: "50", phosphorus: "150", potassium: "50" }),
    });

    console.log("--- Sending High Potassium (250) ---");
    await fetch(`${baseUrl}/send-data`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ ...commonData, nitrogen: "50", phosphorus: "50", potassium: "250" }),
    });
